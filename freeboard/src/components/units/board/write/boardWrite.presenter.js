...
export default function NewBoardUI(props){
  

    return (
      <MyStyle.BackGround>
        <MyStyle.MyTitle>게시물 등록</MyStyle.MyTitle>
        <MyStyle.MyBody>
          <MyStyle.BackTop>
            <MyStyle.TopLt>
        ...
        <MyStyle.InBox onClick={props.PutOk} isActive={props.isActive}>등록하기</MyStyle.InBox>
      </MyStyle.BackGround>
    );
  }
